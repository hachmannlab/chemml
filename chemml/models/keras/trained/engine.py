...
class DataChecker(object):
    def _check_array_input(self, X, name, ndim_must_be, shape_must_be):
        """
        ...
        if isinstance(X, np.ndarray):
            ...
            if X.ndim == ndim_must_be :
                ...
                shape_must_be = self._adapt_shape_array(X, shape_must_be)
                # shape
    ...
    def _adapt_shape_array(self, X, shape_must_be):
        """
